...
{$ENDIF}
  ...
  IDUnitMemLeakMonitor = interface(IMemLeakMonitor)
    ...
    function MemLeakDetected(const AllowedLeakSize: Integer; const FailOnMemoryRecovery: Boolean; out LeakSize: Integer): Boolean; overload;
    function MemLeakDetected(const AllowedValuesGetter: TListIterator; const FailOnMemoryRecovery: Boolean; out LeakIndex: integer; out LeakSize: Integer): Boolean; overload;
    function GetMemoryUseMsg(const FailOnMemoryRecovery: Boolean; const TestProcChangedMem: Integer; out ErrorMsg: string): Boolean; overload;
    function GetMemoryUseMsg(const FailOnMemoryRecovery: boolean; const TestSetupChangedMem: Integer; const TestProcChangedMem: Integer; const TestTearDownChangedMem: Integer; const TestCaseChangedMem: Integer; out ErrorMsg: string): boolean; overload;
  ...
  ITest = interface(IUnknown)
    ...
    property TestMethodInvoked: Boolean read GetTestMethodInvoked write SetTestMethodInvoked;
    ...
    property FailsOnNoChecksExecuted: Boolean read GetFailsOnNoChecksExecuted write SetFailsOnNoChecksExecuted;
    function GetFailsOnMemoryLeak: Boolean;
    procedure SetFailsOnMemoryLeak(const Value: Boolean);
    property FailsOnMemoryLeak: Boolean read GetFailsOnMemoryLeak write SetFailsOnMemoryLeak;
    function GetAllowedMemoryLeakSize: Integer;
    procedure SetAllowedMemoryLeakSize(const NewSize: Integer);
    property AllowedMemoryLeakSize: Integer read GetAllowedMemoryLeakSize write SetAllowedMemoryLeakSize;
    function GetFailsOnMemoryRecovery: Boolean;
    procedure SetFailsOnMemoryRecovery(const Value: Boolean);
    property FailsOnMemoryRecovery: Boolean read GetFailsOnMemoryRecovery write SetFailsOnMemoryRecovery;
    ...
    property IgnoreSetUpTearDownLeaks: Boolean read GetIgnoreSetUpTearDownLeaks write SetIgnoreSetUpTearDownLeaks;
  ...
  public
    ...
    property FailsIfNoChecksExecuted: Boolean read fFailsIfNoChecksExecuted write fFailsIfNoChecksExecuted;
    property FailsIfMemoryLeaked: Boolean read fFailsIfMemoryLeaked write fFailsIfMemoryLeaked;
    property IgnoresMemoryLeakInSetUpTearDown: Boolean read FIgnoresMemoryLeakInSetUpTearDown write FIgnoresMemoryLeakInSetUpTearDown;
    property MemoryLeakIgnoredInSetupOrTearDown: Boolean read FMemoryLeakIgnoredInSetupOrTearDown write FMemoryLeakIgnoredInSetupOrTearDown;
...
const
  sExpButWasFmt = '%sexpected [%s] but was [%s]';
...
function TDUnitMemLeakMonitor.MemLeakDetected(const AllowedLeakSize: Integer; const FailOnMemoryRecovery: Boolean; out LeakSize: Integer): Boolean;
begin
  inherited MemLeakDetected(LeakSize);
  Result := (AllowedLeakSize <> 0);
end;

function TDUnitMemLeakMonitor.MemLeakDetected(const AllowedValuesGetter: TListIterator; const FailOnMemoryRecovery: Boolean; out LeakIndex: integer; out LeakSize: Integer): Boolean;
begin
  inherited MemLeakDetected(LeakSize);
  LeakIndex := 0;
...
function TDUnitMemLeakMonitor.GetMemoryUseMsg(const FailOnMemoryRecovery: Boolean; const TestProcChangedMem: Integer; out ErrorMsg: string): Boolean;
begin
  ErrorMsg := '';
  Result := True;
end;

function TDUnitMemLeakMonitor.GetMemoryUseMsg(const FailOnMemoryRecovery: boolean; const TestSetupChangedMem: Integer; const TestProcChangedMem: Integer; const TestTearDownChangedMem: Integer; const TestCaseChangedMem: Integer; out ErrorMsg: string): boolean;
begin
  ErrorMsg := '';
  Result := True;
end;
...
procedure TAbstractTest.FailNotEquals(expected, actual: WideString; msg: string = ''; ErrorAddrs: Pointer = nil);
begin
  Fail(notEqualsErrorMessage(expected, actual, msg), ErrorAddrs);
end;

procedure TAbstractTest.FailEquals(expected, actual: WideString; msg: string = ''; ErrorAddrs: Pointer = nil);
begin
  Fail(EqualsErrorMessage(expected, actual, msg), ErrorAddrs);
end;

procedure TAbstractTest.FailNotSame(expected, actual: WideString; msg: string = ''; ErrorAddrs: Pointer = nil);
begin
  Fail(NotSameErrorMessage(expected, actual, msg), ErrorAddrs);
end;

procedure TAbstractTest.CheckEquals(expected, actual: extended; delta: extended; msg: string = '');
begin
  FCheckCalled := True;
...
procedure TAbstractTest.CheckEqualsBin(expected, actual: longword; msg: string = ''; digits: integer = 32);
begin
  FCheckCalled := True;
  if expected <> actual then
...
procedure TAbstractTest.CheckNotEqualsBin(expected, actual: longword; msg: string = ''; digits: integer = 32);
begin
  FCheckCalled := True;
  if (expected = actual) then
...
procedure TAbstractTest.CheckEqualsHex(expected, actual: longword; msg: string = ''; digits: integer = 8);
begin
  FCheckCalled := True;
  if expected <> actual then
...
procedure TAbstractTest.CheckNotEqualsHex(expected, actual: longword; msg: string = ''; digits: integer = 8);
begin
  FCheckCalled := True;
  if (expected = actual) then
...
begin
  ...
  if (result = 0) then // The user may have set the values using SetAllowedLeakArray
  begin
    for i := 0 to Length(FAllowedLeakList) - 1 do // Iterate
    begin
...
procedure TAbstractTest.SetMemoryLeakIgnoredInSetupTearDown(const Value: Boolean);
begin
...
function TMemIniFileTrimmed.ReadString(const Section, Ident, DefaultStr: string): string;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        while (j <= High(FMethodNameList)) and (AName^ <> FMethodNameList[j]) do
          inc(j);
